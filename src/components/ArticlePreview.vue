...
withDefaults(defineProps<ArticlePreviewProps>(), {
	title: 'Test title',
...
<template>
	<article class="group relative flex flex-col items-start">
		...
		<time class="relative z-10 order-first mb-3 flex items-center text-sm text-zinc-400 dark:text-zinc-500 pl-3.5" :datetime="new Date(date).toISOString()">
